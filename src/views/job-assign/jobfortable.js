...
import { JobForapi } from '../apicomp/Apiurls';
...
function DataTable() {
    ...
    const deleteBrand = () => {
        ...
        Axios.delete(`${JobForapi}${selectedRowIddel}`, {
            headers: {
            ...
            .then(() => {
                ...
                setResponseMessage('SuccesssFully Job For Deleted');
    ...
    const handleSubmit = (e) => {
        ...
        Axios.put(`${JobForapi}${selectedRowId}/`, matData, {
            headers: {
                Authorization: `Token ${token}`
            }
        })
            .then((response) => {
                ...
                setResponseMessage('SuccesssFully Job For Updated');
    ...
    return (
        <>
            ...
            <Card sx={{ width: '100%', boxShadow: 0 }}>
                <ApiComponent apiUrl={JobForapi} onDataFetched={setFloordiadata} />
                {responseMessage &&
                    Swal.fire({
                        title: 'success',
                        ...
                        <Grid container spacing={2} justifyContent="center" alignItems="center">
                            <List sx={{ width: '100%', maxWidth: 360 }}>
                                <ListItem>
                                    ...
                                    <ListItemText>
                                        <Typography variant="h3">Update Job For #{selectedRowId}</Typography>
                                    </ListItemText>
                                </ListItem>
                            </List>
                ...
                >
                    <DialogContent>
                        <DialogContentText id="alert-dialog-description">
                            Are you sure want to Delete this job for id #{selectedRowIddel}?
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
                ...
                >
                    <DialogContent>
                        <DialogContentText id="alert-dialog-description">Are you sure want to update this job for?</DialogContentText>
                    </DialogContent>
                    <DialogActions>
