...
import { loginSuccess, setUserId } from '../../../../store/actions';
...
const LoginForm = () => {
    ...
    const handleSubmit = async (values, { setErrors, setStatus, setSubmitting }) => {
        ...
        try {
            ...
            // Simulating successful login with a token response
            // const response = await new Promise((resolve) =>
            //     setTimeout(() => resolve({ data: { auth_token: 'your-actual-token-here' } }), 2000)
            // );
            ...
            const userId = userResponse.data.id;
            localStorage.setItem('id', userId);
            // dispatch(setUserId(userId)); // Dispatch the setUserId action
