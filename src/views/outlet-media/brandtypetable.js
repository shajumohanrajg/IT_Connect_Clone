...
function DataTable() {
    ...
    const deleteBrand = () => {
        ...
        Axios.delete(`${BrandTypeapi}${selectedRowIddel}`, {
            headers: {
            ...
            .then(() => {
                ...
                setResponseMessage('SuccesssFully Brand Type Deleted');
    ...
    const handleSubmit = (e) => {
        ...
        Axios.put(`${BrandTypeapi}${selectedRowId}/`, matData, {
            headers: {
                Authorization: `Token ${token}`
            }
        })
            .then((response) => {
                ...
                setResponseMessage('SuccesssFully Brand Type Updated');
    ...
    return (
        <>
            ...
            <Card sx={{ width: '100%', boxShadow: 0 }}>
                ...
                <ApiComponent apiUrl={BrandTypeapi} onDataFetched={setFloordiadata} />
                        ...
                        <Grid container spacing={2} justifyContent="center" alignItems="center">
                            <List sx={{ width: '100%', maxWidth: 360 }}>
                                <ListItem>
                                    ...
                                    <ListItemText>
                                        <Typography variant="h3">Update Brand Type #{selectedRowId}</Typography>
                                    </ListItemText>
                                </ListItem>
                            </List>
                ...
                >
                    <DialogContent>
                        <DialogContentText id="alert-dialog-description">
                            Are you sure want to Delete this brand type id #{selectedRowIddel}?
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
                ...
                >
                    <DialogContent>
                        <DialogContentText id="alert-dialog-description">Are you sure want to update this brand type?</DialogContentText>
                    </DialogContent>
                    <DialogActions>
