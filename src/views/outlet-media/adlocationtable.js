...
function DataTable() {
    ...
    const deleteBrand = () => {
        ...
        Axios.delete(`${BrandLocationapi}${selectedRowIddel}`, {
            headers: {
            ...
            .then(() => {
                ...
                setResponseMessage('SuccesssFully Brand Location Deleted');
    ...
    const handleSubmit = (e) => {
        ...
        Axios.put(`${BrandLocationapi}${selectedRowId}/`, matData, {
            headers: {
                Authorization: `Token ${token}`
            }
        })
            .then((response) => {
                ...
                setResponseMessage('SuccesssFully Brand Location Updated');
    ...
    return (
        <>
            ...
            <DialogBox open={showDialog} onClose={handleDialogClose} statusCode={statusCode} />
            <Card sx={{ width: '100%', boxShadow: 0 }}>
                <ApiComponent apiUrl={BrandLocationapi} onDataFetched={setFloordiadata} />
                {responseMessage &&
                    Swal.fire({
                        title: 'success',
                        ...
                        <Grid container spacing={2} justifyContent="center" alignItems="center">
                            <List sx={{ width: '100%', maxWidth: 360 }}>
                                <ListItem>
                                    ...
                                    <ListItemText>
                                        <Typography variant="h3">Update Ad Location #{selectedRowId}</Typography>
                                    </ListItemText>
                                </ListItem>
                            </List>
                ...
                >
                    <DialogContent>
                        <DialogContentText id="alert-dialog-description">
                            Are you sure want to Delete this brand location id #{selectedRowIddel}?
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
                ...
                >
                    <DialogContent>
                        <DialogContentText id="alert-dialog-description">
                            Are you sure want to update this brand location?
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
