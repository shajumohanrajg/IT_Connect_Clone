...
const SamplePage = () => {
    ...
    const handleSubmit = (e) => {
        ...
        Axios.post(
            ...
            (response) => {
                ...
                setResponseMessage('SuccesssFully Vendor Created');
    ...
    return (
        <div>
            ...
            <HeaderCard title="Vendor Management" buttonname="Vendor" handleOpen={handleOpen} />
                    ...
                    <Grid container spacing={2} justifyContent="center" alignItems="center">
                        <List sx={{ width: '100%', maxWidth: 360 }}>
                            <ListItem>
                                ...
                                <ListItemText>
                                    <Typography variant="h3">Create Vendor</Typography>
                                </ListItemText>
                            </ListItem>
                        </List>
