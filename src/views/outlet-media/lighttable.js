...
import { Lightapi } from '../apicomp/Apiurls';
...
function DataTable() {
    ...
    const deleteBrand = () => {
        ...
        Axios.delete(`${Lightapi}${selectedRowIddel}`, {
            headers: {
    ...
    const handleSubmit = (e) => {
        ...
        Axios.put(`${Lightapi}${selectedRowId}/`, matData, {
            headers: {
                Authorization: `Token ${token}`
            }
        })
            .then((response) => {
                ...
                setResponseMessage('SuccesssFully Light Type Created');
    ...
    return (
        <>
            ...
            <Card sx={{ width: '100%', boxShadow: 0 }}>
                <ApiComponent apiUrl={Lightapi} onDataFetched={setFloordiadata} />
                {responseMessage &&
                    Swal.fire({
                        title: 'success',
                        ...
                        <Grid container spacing={2} justifyContent="center" alignItems="center">
                            <List sx={{ width: '100%', maxWidth: 360 }}>
                                <ListItem>
                                    ...
                                    <ListItemText>
                                        <Typography variant="h3">Update Light Type #{selectedRowId}</Typography>
                                    </ListItemText>
                                </ListItem>
                            </List>
                ...
                >
                    <DialogContent>
                        <DialogContentText id="alert-dialog-description">
                            Are you sure want to Delete this light type id #{selectedRowIddel}?
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
        ...
        itemDescription={`light type id #${selectedItemId}`}
      /> */}
      ...
      /> */}
                ...
                >
                    <DialogContent>
                        <DialogContentText id="alert-dialog-description">Are you sure want to update this ligth type?</DialogContentText>
                    </DialogContent>
                    <DialogActions>
