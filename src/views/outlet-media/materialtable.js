...
import { Materialapi } from '../apicomp/Apiurls';
...
function DataTable() {
    ...
    const deleteBrand = () => {
        ...
        Axios.delete(`${Materialapi}${selectedRowIddel}`, {
            headers: {
    ...
    const handleSubmit = (e) => {
        ...
        Axios.put(`${Materialapi}${selectedRowId}/`, matData, {
            headers: {
                Authorization: `Token ${token}`
            }
        })
            .then((response) => {
                ...
                setResponseMessage('SuccesssFully Material Type Created');
    ...
    return (
        <>
            ...
            <Card sx={{ width: '100%', boxShadow: 0 }}>
                <ApiComponent apiUrl={Materialapi} onDataFetched={setFloordiadata} />
                {responseMessage &&
                    Swal.fire({
                        title: 'success',
                        ...
                        <Grid container spacing={2} justifyContent="center" alignItems="center">
                            <List sx={{ width: '100%', maxWidth: 360 }}>
                                <ListItem>
                                    ...
                                    <ListItemText>
                                        <Typography variant="h3">Update Material Table #{selectedRowId}</Typography>
                                    </ListItemText>
                                </ListItem>
                            </List>
                ...
                >
                    <DialogContent>
                        <DialogContentText id="alert-dialog-description">
                            Are you sure want to Delete this Material id #{selectedRowIddel}?
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
                ...
                >
                    <DialogContent>
                        <DialogContentText id="alert-dialog-description">Are you sure want to update this material?</DialogContentText>
                    </DialogContent>
                    <DialogActions>
