...
function DataTable() {
    ...
    const deleteBrand = () => {
        ...
        Axios.delete(`${Statusapi}${selectedRowIddel}`, {
            headers: {
            ...
            .then(() => {
                ...
                setResponseMessage('SuccesssFully Status Deleted');
    ...
    const handleSubmit = (e) => {
        ...
        Axios.put(`${Statusapi}${selectedRowId}/`, matData, {
            headers: {
                Authorization: `Token ${token}`
            }
        })
            .then((response) => {
                ...
                setResponseMessage('SuccesssFully Status Updated');
    ...
    return (
        <>
            ...
            <Card sx={{ width: '100%', boxShadow: 0 }}>
                <ApiComponent apiUrl={Statusapi} onDataFetched={setFloordiadata} />
                {responseMessage &&
                    Swal.fire({
                        title: 'success',
                        ...
                        <Grid container spacing={2} justifyContent="center" alignItems="center">
                            <List sx={{ width: '100%', maxWidth: 360 }}>
                                <ListItem>
                                    ...
                                    <ListItemText>
                                        <Typography variant="h3">Update Status #{selectedRowId}</Typography>
                                    </ListItemText>
                                </ListItem>
                            </List>
                            ...
                            <Grid item xs={12} md={12} xl={12}>
                                <FormControl fullWidth className={classes.select}>
                                    ...
                                    <Select
                                        ...
                                        id="visibility"
                                        value={matData.visibility || ''}
                                        onChange={(e) => setMatData({ ...matData, visibility: e.target.value })}
                                        label="Visibility"
                                    >
                ...
                >
                    <DialogContent>
                        <DialogContentText id="alert-dialog-description">
                            Are you sure want to Delete this status id #{selectedRowIddel}?
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
                ...
                >
                    <DialogContent>
                        <DialogContentText id="alert-dialog-description">Are you sure want to update this status?</DialogContentText>
                    </DialogContent>
                    <DialogActions>
