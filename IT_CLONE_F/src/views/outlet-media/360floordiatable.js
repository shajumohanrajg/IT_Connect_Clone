...
function DataTable() {
    ...
    const deleteBrand = () => {
        ...
        Axios.delete(`${DegreeImageapi}${selectedRowIddel}`, {
            headers: {
            ...
            .then(() => {
                ...
                setResponseMessage('SuccesssFully 360 Degree Image Deleted');
    ...
    const handleSubmit = (e) => {
        ...
        Axios.put(`${DegreeImageapi}${selectedRowId}/`, matData, {
            headers: {
                Authorization: `Token ${token}`
            }
        })
            .then((response) => {
                setResponseMessage('SuccesssFully 360 degree image Updated');
    ...
    return (
        <>
            ...
            <Card sx={{ width: '100%', boxShadow: 0 }}>
                <ApiComponent apiUrl={DegreeImageListapi} onDataFetched={setFloordiadata} />
                        ...
                        <Grid container spacing={2} justifyContent="center" alignItems="center">
                            <List sx={{ width: '100%', maxWidth: 360 }}>
                                <ListItem>
                                    ...
                                    <ListItemText>
                                        <Typography variant="h3">Update 360 Floor Diagram #{selectedRowId}</Typography>
                                    </ListItemText>
                                </ListItem>
                            </List>
                            ...
                            <Grid item xs={12} md={12} xl={12}>
                                <FormControl fullWidth className={classes.select}>
                                    ...
                                    <Select
                                        value={matData.grade || ''}
                                        onChange={(e) => setMatData({ ...matData, grade: e.target.value })}
                                        label="Grade"
                                    >
                                        <MenuItem value="">
                            ...
                            <Grid item xs={12} md={12} xl={12}>
                                <TextField
                                    ...
                                    id="url"
                                    value={matData.url || ''}
                                    onChange={(e) => setMatData({ ...matData, url: e.target.value })}
                                    fullWidth
                                    type="url"
                                    variant="outlined"
                ...
                >
                    <DialogContent>
                        <DialogContentText id="alert-dialog-description">
                            Are you sure want to Delete this 360 Floor Diagram id #{selectedRowIddel}?
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
                ...
                >
                    <DialogContent>
                        <DialogContentText id="alert-dialog-description">
                            Are you sure want to update this 360 floor Diagarm?
                        </DialogContentText>
                    </DialogContent>
                    <DialogActions>
